...
```curl
curl \
    --header "X-Consul-Token: a828187d-0c64-d953-3b1b-7fa49c91934b" \
    http://127.0.0.1:9500/v1/kv/foo/test
```

```curl
curl \
    --header "X-Consul-Token: a828187d-0c64-d953-3b1b-7fa49c91934b" \
    http://127.0.0.1:9500/v1/kv/foo/bien
```
    
```curl
curl \
    --header "X-Consul-Token: a828187d-0c64-d953-3b1b-7fa49c91934b" \
    http://127.0.0.1:9500/v1/kv/foo/test2
```
## References
